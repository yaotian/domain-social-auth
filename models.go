...
func (e *DomainUserSocial) Save() (err error) {
	o := orm.NewOrm()
	if e.Id == 0 {
		_, err = o.Insert(e)
	} else {
...
func (e *DomainUserSocial) Token() (*Token, error) {
	return e.Data.Token, nil
}

func (e *DomainUserSocial) PutToken(token *Token) error {
	if token == nil {
...
func (e *DomainUserSocial) TableUnique() [][]string {
	return [][]string{
		{"Identify", "Type"},
	}
}
func (e *DomainUserSocial) Insert() error {
...
func (e *DomainUserSocial) Read(fields ...string) error {
...
func (e *DomainUserSocial) Update(fields ...string) error {
...
func (e *DomainUserSocial) Delete() error {
...
func UserSocials() orm.QuerySeter {
	return orm.NewOrm().QueryTable("domain_user_social")
}

// Get UserSocials by uid
func GetSocialsByUid(uid int, socialTypes ...SocialType) ([]*DomainUserSocial, error) {
	var userSocials []*DomainUserSocial
...
func init() {
	orm.RegisterModel(new(DomainUserSocial))
}
